...
const IndexPage = () => {
  ...
  return (
    <>
      <Head>
        <link rel="canonical" href="https://chillvision.ru/catalog" />
        <meta property="og:title" content="Каталог" />
        <meta property="og:description" content="Уникальная мультимедийная платформа для просмотра веб-сериалов." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content={"https://chillvision.ru/catalog"} />
