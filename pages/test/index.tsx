  ...
  return (
    <div>
      ...
      <div className="relative inline-block">
        ...
        <div className={`absolute inset-0 w-full h-full ${panelState}`} onClick = {() => showRealPanel()}>
          ...
          <div className="flex justify-between flex-wrap content-center h-full inline-block items-center px-4 ">
            <div className="w-24">
              <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg" className={`playerButtons ${currentSerie == 0 ? "hidden" : ""}`} onClick = {() => changeVideo("prev")}>
                  <path d="M0 8C0 3.58172 3.58172 0 8 0H52C56.4183 0 60 3.58172 60 8V52C60 56.4183 56.4183 60 52 60H8C3.58172 60 0 56.4183 0 52V8Z" fill="white" fillOpacity="0.2"/>
