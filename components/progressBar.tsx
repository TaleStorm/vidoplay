...
export default function ProgressBar(data:ProgressBarProps) {
    ...
    <div  className={`absolute bottom-4 inset-x-0 mx-4 w-auto flex items-end `}>
        <svg width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg" className={`mr-2 playerButtons ${data.isPlaying? "hidden" : ""}`} onClick={() => data.setPlay()}>
        ...
        <svg width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg" className={`mr-2 playerButtons ${data.isPlaying? "" : "hidden"}`} onClick={() => data.setPlay()}>
            <path className="wrapper" d="M0 8C0 3.58172 3.58172 0 8 0H34C38.4183 0 42 3.58172 42 8V34C42 38.4183 38.4183 42 34 42H8C3.58172 42 0 38.4183 0 34V8Z" fill="white" fill-opacity="0.2"/>
        ...
        <div  className={`relative w-full h-5 cursor-pointer`} onMouseMove= {(e) => data.getMousePos(e)}  onClick= {(e) => data.setCurrentDuration(e)}>
