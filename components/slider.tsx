...
const Slider = (data: SliderProps) => (
      ...
      <div className="relative">
        ...
        <div  className="ml-5 absolute inset-y-0 left-0 h-full flex flex-wrap content-center inline-block z-30" id="prevMainSlide">
        ...
        <div  className="mr-5 absolute inset-y-0 right-0 h-full flex flex-wrap content-center inline-block z-30" id="nextMainSlide">
          <svg width="20" height="38" viewBox="0 0 20 38" fill="none" xmlns="http://www.w3.org/2000/svg">
