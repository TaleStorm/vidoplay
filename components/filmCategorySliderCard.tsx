...
const FilmCategorySliderCard = (data) => {
	...
	return (
	  ...
	  className="bg-cardBackground cursor-pointer relative transform transition-all duration-400 lg:hover:-translate-y-2.5 shadow-none lg:hover:shadow-card-hover flex flex-col h-full">
			...
			<div ref={imgRef} className={`bg-cover relative bg-center flex-shrink-0`}>
				{/* <Image
					src={data.image}
					...
					objectFit="cover"
				/> */}
				<img style={{width:"100%"}} onError={()=>{setIsImageFailed(true)}} src={isImageFailed ? "/images/FilmSoon.png" : data.image}/>
