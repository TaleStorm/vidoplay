  	...
  	<div className="py-10">
			...
			<div className="space-y-4">
				{data.comments.map((comment, i) => {    
					return <div className="bg-cardBackground grid grid-cols-12 grid-rows-1 gap-4 pt-3 pb-5" key={i}>
						<div className="col-span-10 grid justify-items-start">
							<a href="#" className="text-xl ml-7 block">
						...
						<div className="col-span-2 grid justify-items-end mr-8">
