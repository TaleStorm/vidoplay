...
export default class ForgottenPass extends Component<ForgottenPassProps, {passwordField:string}>  {
  constructor(props: ForgottenPassProps) {
    super(props);
  ...
  public render(): React.ReactElement<ForgottenPassProps> {
    return (
      <div className={this.props.hidden ? "" : "hidden"}>
        <div className="fixed inset-0 z-40 bg-shadow opacity-10" id="shadow">
        </div>
        <div className="fixed max-w-md mx-auto z-50 inset-16 bottom-60 bg-popupBackground opacity-100" id="authoritation">
