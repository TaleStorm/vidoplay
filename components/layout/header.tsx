...
const HeadNav = ({pathname, context}) => {
  ...
  const currentHref = () => {
    ...
    return (
      ...
      <img
      src="/images/logo.png"
      className={`h-11 w-auto mt-6 block sm:hidden relative z-20`}/>
      }
      <div className={`absolute w-full sm:hidden flex justify-center text-ui-text mt-6`}>
            {currentNav()}
      </div>
      </>
...
export default function Header() {
  ...
  return (
    ...
    <div className={`w-full h-22 flex-shrink-0`}>
