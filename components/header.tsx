            ...
            <nav className="flex justify-end">
              <a href="#" className="text-sm text-base text-black-500 hover:text-gray-900 ml-5">
                <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path d="M19.8218 19.8217L26.2501 26.25" stroke="white" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round"/>
                </svg>
              </a>
              <a href="#" className=" text-sm text-base text-black-500 hover:text-gray-900 ml-5">
                <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path d="M3.63135 25.3114C4.78396 23.3164 6.44128 21.6598 8.43684 20.508C10.4324 19.3563 12.6959 18.75 15 18.75C17.304 18.75 19.5675 19.3564 21.563 20.5082C23.5586 21.6599 25.2159 23.3166 26.3684 25.3116" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
              </a>
            </nav>
