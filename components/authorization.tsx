        ...
        <div className="fixed max-w-md mx-auto z-50 inset-16 bg-popupBackground opacity-100" id="authoritation">
          <div className="py-8 px-8 rounded-xl">
            ...
            <h3 className="text-mainText mt-5 text-center font-roboto text-base">
              ...
              <a className="text-orange hover:text-orange underline text-base" href="#">Зарегестрируйтесь!</a>
            </h3>
            ...
            <h3 className="text-mainText mt-5 text-center font-roboto text-base">
              <a className="text-orange hover:text-orange underline" href="#">Я не помню пароль</a>
            </h3>
