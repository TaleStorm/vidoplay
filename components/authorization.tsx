...
export default class Authorization extends Component<AuthorizationProps, {passwordField:string}>  {
  ...
  public render(): React.ReactElement<AuthorizationProps> {
    return (
      <div className={this.props.hidden ? "" : "hidden"}>
        <div className="fixed inset-0 z-40 bg-shadow opacity-10" id="shadow">
        </div>
        <div className="fixed max-w-md mx-auto z-50 inset-16 bg-popupBackground opacity-100" id="authoritation">
          <div className="py-8 px-8 rounded-xl">
            <a className="absolute top-3 right-3" onClick={this.props.hideFunc}>
            ...
            <h1 className="font-medium text-2xl mt-3 text-center text-3xl font-roboto text-mainText font-medium">
              Авторизация
            </h1>
            ...
            <form action="" className="mt-6">
              ...
              <div className="mb-5 text-sm">
                <input type="text" autoFocus id="email" className="border border-popupBorder rounded-lg px-6 py-3 mt-3 focus:outline-none bg-popupBackground w-full" placeholder="Введите email" />
              </div>
              ...
              <div className="text-sm relative mt-3 mb-2 pt-4">
                <input type="checkbox" id="policity" className="hidden" />
                <label htmlFor="policity" className="inline text-mainText -py-2">
                  <span className="opacity-80">
                    Я ознакомлен с
                  </span>
                  <a className="hover:text-orange" href="#"> политикой конфиденциальности </a>
                  <span className="opacity-80">
                    и  
                  </span>
                  <a className="hover:text-orange" href="#"> правилами пользования сервиса</a>
                </label>
              </div>
            ...
            <h3 className="text-mainText mt-5 text-center font-roboto text-base">
              ...
              <a className="text-orange hover:text-orange underline text-base" onClick={this.props.regFunc}>Зарегестрируйтесь!</a>
            </h3>
            ...
            <a href="#" className="self-center">
              ...
              <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M20 14.6845C21.6274 14.6845 22.7252 15.3874 23.3511 15.9749L25.7971 13.5867C24.2948 12.1904 22.34 11.3334 20 11.3334C16.6104 11.3334 13.683 13.2786 12.2578 16.1097L15.06 18.286C15.763 16.1963 17.7082 14.6845 20 14.6845Z" fill="#EA4335"/>
                <path d="M28.32 20.1926C28.32 19.48 28.2622 18.96 28.137 18.4208H20V21.6371H24.7763C24.68 22.4363 24.16 23.64 23.0044 24.4489L25.7393 26.5674C27.3763 25.0556 28.32 22.8311 28.32 20.1926Z" fill="#4285F4"/>
                <path d="M15.0698 21.7141C14.8868 21.1748 14.7809 20.597 14.7809 20C14.7809 19.403 14.8868 18.8252 15.0602 18.2859L12.2579 16.1096C11.6705 17.2844 11.3335 18.6037 11.3335 20C11.3335 21.3963 11.6705 22.7155 12.2579 23.8904L15.0698 21.7141Z" fill="#FBBC05"/>
                <path d="M20.0002 28.6667C22.3402 28.6667 24.3046 27.8963 25.7394 26.5675L23.0046 24.4489C22.2728 24.9593 21.2905 25.3156 20.0002 25.3156C17.7083 25.3156 15.7631 23.8037 15.0698 21.7141L12.2676 23.8904C13.6928 26.7215 16.6105 28.6667 20.0002 28.6667Z" fill="#34A853"/>
              </svg>
            </a>
            ...
            <h3 className="text-mainText mt-5 text-center font-roboto text-base">
              <a className="text-orange hover:text-orange underline" onClick={this.props.forPassFunc}>Я не помню пароль</a>
            </h3>
