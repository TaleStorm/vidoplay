...
export default function Registration(data: RegistrationProps) {
  ...
  return (
    <div className={`${data.hidden} w-full`}>
      ...
      <div className="fixed mx-5 sm:max-w-md sm:mx-auto z-50 sm:inset-16 bg-popupBackground opacity-100 w-full" id="authoritation">
        <div className="pt-3 pb-8 sm:py-8 px-4 sm:px-8 rounded-xl">
          ...
          <form action="" className="mt-3 sm:mt-6">
            ...
            <label htmlFor="username" className="block">Имя</label>
