...
export default class Registration extends Component<RegistrationProps, {passwordField:string}>  {
  ...
  public render(): React.ReactElement<RegistrationProps> {
    return (
          ...
          <div className="py-8 px-8 rounded-xl">
            ...
            <form action="" className="mt-6">
              ...
              <div className="mb-5 text-sm">
                <input type="text" autoFocus id="email" className="border border-popupBorder rounded-lg px-6 py-3 mt-3 focus:outline-none bg-popupBackground w-full" placeholder="Введите имя" />
              </div>
            ...
            <h3 className="text-mainText mt-5 text-center font-roboto text-base">
              ...
              <a className="text-orange hover:text-orange underline text-base" onClick={this.props.authFunc}>аккаунт</a>
            </h3>
