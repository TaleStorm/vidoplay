const CommentForm = (data: { onInputChange: Function, onSubmit: Function, value: any }) => (
  <div className="ml-7">
    ...
    <div
      className="mb-3 border-2 h-48 rounded-lg sm:px-8 py-4 pl-4 pr-2 sm:py-6 mt-3 focus-within:outline-none bg-popupBackground w-full text-ui-text focus-within:border-orange hover:border-orange border-popupBorder  transition-all duration-200 ease-out"
    >
      <textarea
        style={{ resize: "none" }}
